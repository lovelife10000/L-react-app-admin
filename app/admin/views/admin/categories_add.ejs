<%- include('header') %>
<div class="content-wrapper" ng-controller="categoriesAdd">
                    ...
                    <form class="form-horizontal" name="myForm">
                        <div class="box-body">
                            <div class="form-group"
                                 ng-class="{'has-warning':myForm.cate_name.$invalid && !myForm.cate_name.$pristine,'has-success':myForm.cate_name.$valid && !myForm.cate_name.$pristine,'has-error':isUsernameExist}">
                                <label for="username" class="col-sm-2 control-label">分类名称</label>

                                <div class="col-sm-10">
                                    <input type="text" name="cate_name" ng-model="cate_name" class="form-control"
                                           id="cate_name" placeholder="请输入用户名" ng-minlength="2" ng-maxlength="20"
                                            required>
                            ...
                            <div class="form-group"
                                 ng-class="{'has-warning':myForm.cate_slug.$invalid && !myForm.cate_slug.$pristine,'has-success':myForm.cate_slug.$valid && !myForm.cate_slug.$pristine,'has-error':isUsernameExist}">
                                <label for="nickname" class="col-sm-2 control-label">别名</label>

                                <div class="col-sm-10">
                                    <input type="text" name="cate_slug" ng-model="cate_slug" class="form-control"
                                           id="cate_slug" placeholder="请输入别名" ng-pattern="/^[a-zA-Z]\w{1,19}$/"
                                           required>
                                    <span class="help-block ng-hide"
                            ...
                            <div class="form-group"
                                 ng-class="{'has-warning':myForm.cate_order.$invalid && !myForm.cate_order.$pristine,'has-success':myForm.cate_order.$valid && !myForm.cate_order.$pristine,'has-error':isUsernameExist}">
                                <label for="password" class="col-sm-2 control-label">排序</label>

                                <div class="col-sm-10">
                                    <input type="password" name="cate_order" ng-model="cate_order" class="form-control"
                                           id="password" placeholder="请输入排序数字" ng-pattern="/^\d{1,4}$/" required>
                                    <span class="help-block ng-hide"
                            ...
                            <div class="form-group"
                                 ng-class="{'has-warning':myForm.cate_parent.$invalid && !myForm.cate_parent.$pristine,'has-success':myForm.cate_parent.$valid && !myForm.cate_parent.$pristine,'has-error':isUsernameExist}">
                                <label class="col-sm-2 control-label">父级</label>
                                <div class="col-sm-10">
                                    <select class="form-control" name="cate_parent" ng-model="cate_parent"
                            ...
                            <div class="form-group"
                                 ng-class="{'has-warning':myForm.cate_remark.$invalid && !myForm.cate_remark.$pristine,'has-success':myForm.cate_remark.$valid && !myForm.cate_remark.$pristine,'has-error':isUsernameExist}">
                                <label class="col-sm-2 control-label">备注</label>
                                <div class="col-sm-10">
                                    <textarea name="cate_remark" ng-model="cate_remark" class="form-control" rows="3"
                        ...
                        <div class="box-footer">
                            ...
                            <button type="submit" class="btn btn-info pull-right" ng-click="categoriesAdd()">添加分类
                            </button>
                        </div>
                        <!-- /.box-footer -->
                    </form>
