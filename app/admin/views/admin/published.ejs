<%- include('header') %>
<div class="content-wrapper" ng-controller="published">
            ...
            <div class="row">
              <table class="table table-bordered">
                ...
                <tr ng-repeat="x in data">
                  ...
                  <td>
                    <button type="button" class="btn btn-primary btn-xs btn-flat" ng-click="edit(x)">编辑</button>
                    <button type="button" class="btn btn-info btn-xs btn-flat">推荐</button>
                    <button type="button" class="btn btn-danger btn-xs btn-flat">取消推荐</button>
