              ...
              <div className="box box-primary">
                ...
                <form className="form-horizontal" onSubmit={handleSubmit(this.addUser)}>
                  <div className="box-body">
                    <UploadDocImage/>
                    <Field name="title" component={renderField} type="text" placeholder="标题"/>
                    <Field name="category" className="form-control" component={renderFieldForSelect} type="text" placeholder="分类"/>
                    ...
                    <div  className="form-group">
                      ...
                      <div className="col-sm-8">
                        <div className="radio">
                          <label>
                            <Field name="type" component="input" type="radio" value="post" checked/>
                            文章
                          </label>
                        </div>
                        <div className="radio">
                          <label>
                            <Field name="type" component="input" type="radio" value="page" />
                            页面
                          </label>
                        </div>
                      </div>
                    ...
                    <div  className="form-group">
                      ...
                      <div className="col-sm-8">
                        <div className="radio">
                          <label>
                            <Field name="status" id="published" component="input" type="radio" value="published"  checked/>
                            已发布
                          </label>
                        </div>
                        <div className="radio">
                          <label>
                            <Field name="status" id="waitForVerify" component="input" type="radio" value="waitForVerify" />
                            待审核
                          </label>
                        </div>
                        <div className="radio">
                          <label>
                            <Field name="status" id="noAccess" component="input" type="radio" value="noAccess" />
                            未通过
                          </label>
                        ...
                        <div className="radio">
                          <label>
                            <Field name="status" id="draft" component="input" type="radio" value="draft" />
                            草稿箱
                          </label>
                        </div>
                      </div>
                    ...
                    <div className="form-group">
                      <label className="col-sm-2 control-label"  htmlFor="top">置顶</label>
                      <div className="col-sm-8">
                    ...
                    <div className="form-group">
                      <label className="col-sm-2 control-label"  htmlFor="hot">热门</label>
                      <div className="col-sm-8">
                        <Field
                          name="hot"
                          id="hot"
                    ...
                    <div className="form-group">
                      ...
                      <div className="col-sm-8">
                        <select className="form-control select2" multiple="multiple" data-placeholder="选择一个标签" style={{width: '100%'}}>
                    ...
                    <Field name="phone" component={renderField} type="text" placeholder="来源"/>


                    <Field name="nickname" component={renderField} type="text" placeholder="访问数"/>
                    <Field name="password" component={renderField} type="text" placeholder="点赞数"/>
                    <Field name="rePassword" component={renderField} type="text" placeholder="关键词"/>
                    <Field name="rePassword" component={renderField} type="text" placeholder="描述"/>
                    <Field name="remark" className="form-control" component={renderFieldForTextarea} type="text" placeholder="摘要"/>
